...
const Register = ({LoginHandler}) => {
  ...
  >
    ...
    <div className="inputForm">
      ...
      <input placeholder="Enter your Name" className="input" type="text"  onChange={(e)=>setName(e.target.value)} required/>
    </div>
    <div className="flex-column">
      <label>Email</label>
    </div>
    <div className="inputForm">
      ...
      <input placeholder="Enter your Email" className="input" type="text" onChange={(e)=>setEmail(e.target.value)} required/>
    </div>
    ...
    <div className="inputForm">
      ...
      <input placeholder="Enter your Password" className="input" type="password" onChange={(e)=>setPassword(e.target.value)} required/>
    </div>
